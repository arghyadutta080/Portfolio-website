...
const TechStacks = () => {
    ...
    const techStacks = ["vscode", "c", "cpp", "python", "html", "css", "javascript", "typescript", "react", "redux", "bootstrap", "tailwind", "nodejs", "express", "django", "mongodb", "firebase", "replit", "git", "github", "netlify", "vercel", "postman"]
