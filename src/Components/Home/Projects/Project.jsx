...
const Project = () => {
    return (
        <div className='flex flex-col items-center md:px-32 lg:px-40 z-10 relative border-transparent' id='project'>
            <h1 className=' text-white mt-14 lg:mt-5 lg:py-2 flex flex-col justify-center space-y-1'>
                <p className='mx-auto text-xl lg:text-2xl md:text-2xl font-normal'>PROJECTS</p>
                <p className='mx-auto text-3xl lg:text-5xl md:text-4xl font-medium md:w-2/3 w-3/4 text-center'>Some of my hard work is showcased in ...</p>
            </h1>
            <div className=' flex flex-row justify-around flex-wrap w-full my-5'>
                {
                    Projects.map((project, index) => {
                        return (
                            <div key={index} className=' w-[80%] lg:w-[48%] h-60 text-white bg-project flex flex-col justify-between rounded-xl my-5 p-5'>
